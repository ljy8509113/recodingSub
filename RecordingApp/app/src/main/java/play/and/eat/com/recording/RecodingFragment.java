...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_recoding, container, false);
    }
...
//        view.findViewById(R.id.info).setOnClickListener(this);
        ((Button)view.findViewById(R.id.button_setting)).setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.button_setting: {
                if(_viewSetting.getVisibility() == View.GONE){
                    _viewSetting.setVisibility(View.VISIBLE);
                    SharedPreferences pref = getActivity().getSharedPreferences(Common.SHARE_DATA_KEY, Context.MODE_PRIVATE);
                    _viewSetting.setData(pref);
                }
